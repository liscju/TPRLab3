...
mpiexec -n 1 ./lab4.out 100000000 -b
mpiexec -n 2 ./lab4.out 100000000 -b
mpiexec -n 4 ./lab4.out 100000000 -b
mpiexec -n 6 ./lab4.out 100000000 -b
mpiexec -n 8 ./lab4.out 100000000 -b
mpiexec -n 10 ./lab4.out 100000000 -b
mpiexec -n 12 ./lab4.out 100000000 -b
...
mpiexec -n 1 ./lab4.out 100000000 -sc
mpiexec -n 2 ./lab4.out 100000000 -sc
mpiexec -n 4 ./lab4.out 100000000 -sc
mpiexec -n 6 ./lab4.out 100000000 -sc
mpiexec -n 8 ./lab4.out 100000000 -sc
mpiexec -n 10 ./lab4.out 100000000 -sc
mpiexec -n 12 ./lab4.out 100000000 -sc
